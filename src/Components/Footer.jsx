        ...
        <div className='bg-orange-50 mt-16'>
            <div className='grid gap-5 grid-cols-1 lg:grid-cols-4 py-20  max-w-7xl mx-auto'>
                <div>
                    ...
                    <p className='flex items-center gap-2 mt-6 font-semibold text-gray-600'><IoCallSharp/> <span>+880 123456789</span></p>
                    <p className='flex items-center gap-2 mt-6 font-semibold text-gray-600'><FaLocationDot/> <span>123, ABC Street, Dhaka</span></p>
                </div>
                <div>
                    <h1 className="text-xl font-semibold font-barlow uppercase border-b pb-1 border-gray-400">Category</h1>
                    <ul className='space-y-3 mt-3  font-semibold text-gray-600'>
